...
dfs = []
path = r"..\web\data\data_cluster_gpi\data_gpi_2013.csv"
for i in [2013, 2015, 2016, 2017, 2018, 2019, 2021, 2022, 2023]:
...
#df = pd.read_csv(r"..\web\data\data_cluster_gpi\data_gpi_2013.csv", sep='\t')\
